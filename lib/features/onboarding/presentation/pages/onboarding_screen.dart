...
// Here is the complete, self-contained Flutter code to recreate the **Pulse Onboarding Screen** with accurate visual styling and fluid card animations.

// ### Highlights of this Implementation:
// - **Card Animations**:
//   - **Staggered Entrance**: Card slides up, scales up, and fades in smoothly on launch (`Curves.easeOutBack`).
//   - **Continuous Subtle Floating Effect**: Idle levitation animation using a smooth sine curve.
//   - **Interactive 3D Tilt Effect**: Touch/drag the ticket card to tilt it interactively in 3D space.
// - **Pixel-Accurate Design**:
//   - Custom dashed divider line between ticket sections.
//   - Custom QR code renderer (no external packages needed).
//   - Rich typography, badges, gradients, drop shadows, and responsive layout.
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              backgroundColor: const Color(0xFF4342E6),
              elevation: 0,
